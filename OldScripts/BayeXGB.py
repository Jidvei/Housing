...
def trainxgb(params):
    ...
    for i in range(n_iters):
        ...
        xgb_model = xgb.train(params, dtrain, 5000, watchlist, early_stopping_rounds = 150)
...
def trainlgb(params):
    ...
    for i in range(n_iters):
        ...
        lgb_model = lgb.train(params, dtrain, 5000, valid_sets=dvalid, early_stopping_rounds = 150)
